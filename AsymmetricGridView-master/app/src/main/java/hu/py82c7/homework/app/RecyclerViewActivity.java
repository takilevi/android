...
import hu.py82c7.homework.AGVRecyclerViewAdapter;
import hu.py82c7.homework.AsymmetricItem;
import hu.py82c7.homework.AsymmetricRecyclerView;
import hu.py82c7.homework.AsymmetricRecyclerViewAdapter;
...
public class RecyclerViewActivity extends AppCompatActivity {
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    RecyclerViewAdapter adapter = new RecyclerViewAdapter(demoUtils.moarItems());
