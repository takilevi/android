...
import hu.py82c7.homework.AsymmetricGridView;
import hu.py82c7.homework.AsymmetricGridViewAdapter;
import hu.py82c7.homework.Utils;
import hu.py82c7.homework.app.model.DemoItem;
import hu.py82c7.homework.app.widget.DefaultCursorAdapter;
import hu.py82c7.homework.app.widget.DefaultListAdapter;
import hu.py82c7.homework.app.widget.DemoAdapter;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (USE_CURSOR_ADAPTER) {
      if (savedInstanceState == null) {
        adapter = new DefaultCursorAdapter(this, demoUtils.moarItems());
      } else {
        adapter = new DefaultCursorAdapter(this);
      }
    } else {
      if (savedInstanceState == null) {
        adapter = new DefaultListAdapter(this, demoUtils.moarItems());
      } else {
  ...
  @Override public boolean onOptionsItemSelected(MenuItem item) {
    ...
    if (id == R.id.sixty_dp_columns) {
      ...
      adapter.appendItems(demoUtils.plusoneItem());
    } else if (id == R.id.reset_items) {
      demoUtils.currentOffset = 0;
      adapter.setItems(demoUtils.moarItems());
