...
import hu.py82c7.homework.holder.DimenHolder;
...
public class ContainerDrawerItem extends AbstractDrawerItem<ContainerDrawerItem, ContainerDrawerItem.ViewHolder> {
    ...
    @Override
    public int getType() {
        return hu.py82c7.homework.R.id.material_drawer_item_container;
    }

    @Override
    @LayoutRes
    public int getLayoutRes() {
        return hu.py82c7.homework.R.layout.material_drawer_item_container;
    }
    ...
    public void bindView(ViewHolder viewHolder, List payloads) {
        ...
        divider.setBackgroundColor(UIUtils.getThemeColorFromAttrOrRes(ctx, hu.py82c7.homework.R.attr.material_drawer_divider, hu.py82c7.homework.R.color.material_drawer_divider));
        ...
        if (mViewPosition == Position.TOP) {
            ...
            layoutParams.bottomMargin = ctx.getResources().getDimensionPixelSize(hu.py82c7.homework.R.dimen.material_drawer_padding);
            ((ViewGroup) viewHolder.view).addView(divider, layoutParams);
        } else if (mViewPosition == Position.BOTTOM) {
            layoutParams.topMargin = ctx.getResources().getDimensionPixelSize(hu.py82c7.homework.R.dimen.material_drawer_padding);
            ((ViewGroup) viewHolder.view).addView(divider, layoutParams);
