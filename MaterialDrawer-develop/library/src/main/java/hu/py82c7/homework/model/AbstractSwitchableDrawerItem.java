...
import hu.py82c7.homework.interfaces.OnCheckedChangeListener;
...
public abstract class AbstractSwitchableDrawerItem<Item extends AbstractSwitchableDrawerItem> extends BaseDescribeableDrawerItem<Item, AbstractSwitchableDrawerItem.ViewHolder> {
    ...
    @Override
    public int getType() {
        return hu.py82c7.homework.R.id.material_drawer_item_primary_switch;
    }

    @Override
    @LayoutRes
    public int getLayoutRes() {
        return hu.py82c7.homework.R.layout.material_drawer_item_switch;
    }
    ...
    public static class ViewHolder extends BaseViewHolder {
        ...
        private ViewHolder(View view) {
            super(view);
            this.switchView = (SwitchCompat) view.findViewById(hu.py82c7.homework.R.id.material_drawer_switch);
        }
    }
