...
public class AbstractToggleableDrawerItem<Item extends AbstractToggleableDrawerItem> extends BaseDescribeableDrawerItem<Item, AbstractToggleableDrawerItem.ViewHolder> {
    ...
    @Override
    public int getType() {
        return hu.py82c7.homework.R.id.material_drawer_item_primary_toggle;
    }

    @Override
    @LayoutRes
    public int getLayoutRes() {
        return hu.py82c7.homework.R.layout.material_drawer_item_toggle;
    }
    ...
    public static class ViewHolder extends BaseViewHolder {
        ...
        private ViewHolder(View view) {
            super(view);
            this.toggle = (ToggleButton) view.findViewById(hu.py82c7.homework.R.id.material_drawer_toggle);
        }
    }
