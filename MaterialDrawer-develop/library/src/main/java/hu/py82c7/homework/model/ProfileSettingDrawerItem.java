...
public class ProfileSettingDrawerItem extends AbstractDrawerItem<ProfileSettingDrawerItem, ProfileSettingDrawerItem.ViewHolder> implements IProfile<ProfileSettingDrawerItem>, Tagable<ProfileSettingDrawerItem>, Typefaceable<ProfileSettingDrawerItem> {
    ...
    @Override
    public int getType() {
        return hu.py82c7.homework.R.id.material_drawer_item_profile_setting;
    }

    @Override
    @LayoutRes
    public int getLayoutRes() {
        return hu.py82c7.homework.R.layout.material_drawer_item_profile_setting;
    }
    ...
    public void bindView(ViewHolder viewHolder, List payloads) {
        ...
        int selectedColor = ColorHolder.color(getSelectedColor(), ctx, hu.py82c7.homework.R.attr.material_drawer_selected, hu.py82c7.homework.R.color.material_drawer_selected);
        //get the correct color for the text
        int color = ColorHolder.color(getTextColor(), ctx, hu.py82c7.homework.R.attr.material_drawer_primary_text, hu.py82c7.homework.R.color.material_drawer_primary_text);
        int iconColor = ColorHolder.color(getIconColor(), ctx, hu.py82c7.homework.R.attr.material_drawer_primary_icon, hu.py82c7.homework.R.color.material_drawer_primary_icon);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private ViewHolder(View view) {
            super(view);
            this.view = view;
            this.icon = (ImageView) view.findViewById(hu.py82c7.homework.R.id.material_drawer_icon);
            this.name = (TextView) view.findViewById(hu.py82c7.homework.R.id.material_drawer_name);
        }
    }
}
