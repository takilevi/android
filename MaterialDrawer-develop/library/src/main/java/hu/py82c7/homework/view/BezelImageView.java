...
package hu.py82c7.homework.view;
...
import hu.py82c7.homework.util.DrawerImageLoader;
...
public class BezelImageView extends ImageView {
    ...
    public BezelImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, hu.py82c7.homework.R.styleable.BezelImageView, defStyle, hu.py82c7.homework.R.style.BezelImageView);
        ...
        mDrawCircularShadow = a.getBoolean(hu.py82c7.homework.R.styleable.BezelImageView_biv_drawCircularShadow, true);
