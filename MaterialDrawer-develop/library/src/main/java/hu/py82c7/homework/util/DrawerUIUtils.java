package hu.py82c7.homework.util;
...
import hu.py82c7.homework.icons.MaterialDrawerFont;
...
public class DrawerUIUtils {
    ...
    public static int getOptimalDrawerWidth(Context context) {
        ...
        int maxDrawerWidth = context.getResources().getDimensionPixelSize(hu.py82c7.homework.R.dimen.material_drawer_width);
    ...
    public static Drawable getPlaceHolder(Context ctx) {
        return new IconicsDrawable(ctx, MaterialDrawerFont.Icon.mdf_person).colorRes(hu.py82c7.homework.R.color.accent).backgroundColorRes(hu.py82c7.homework.R.color.primary).sizeDp(56).paddingDp(16);
    }
    ...
    public static void setDrawerVerticalPadding(View v) {
        int verticalPadding = v.getContext().getResources().getDimensionPixelSize(hu.py82c7.homework.R.dimen.material_drawer_vertical_padding);
