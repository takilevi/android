...
public abstract class AbstractBadgeableDrawerItem<Item extends AbstractBadgeableDrawerItem> extends BaseDescribeableDrawerItem<Item, AbstractBadgeableDrawerItem.ViewHolder> implements ColorfulBadgeable<Item> {
    ...
    @Override
    public int getType() {
        return hu.py82c7.homework.R.id.material_drawer_item_primary;/*"PRIMARY_ITEM"*/
    }

    @Override
    @LayoutRes
    public int getLayoutRes() {
        return hu.py82c7.homework.R.layout.material_drawer_item_primary;
    }
    ...
    public static class ViewHolder extends BaseViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            this.badgeContainer = view.findViewById(hu.py82c7.homework.R.id.material_drawer_badge_container);
            this.badge = (TextView) view.findViewById(hu.py82c7.homework.R.id.material_drawer_badge);
        }
    }
}
