...
import hu.py82c7.homework.model.interfaces.Iconable;
import hu.py82c7.homework.model.interfaces.Nameable;
import hu.py82c7.homework.model.interfaces.Tagable;
import hu.py82c7.homework.model.interfaces.Typefaceable;
import hu.py82c7.homework.util.DrawerUIUtils;
...
public abstract class BaseDrawerItem<T, VH extends RecyclerView.ViewHolder> extends AbstractDrawerItem<T, VH> implements Nameable<T>, Iconable<T>, Tagable<T>, Typefaceable<T> {
    ...
    protected int getSelectedColor(Context ctx) {
        return ColorHolder.color(getSelectedColor(), ctx, hu.py82c7.homework.R.attr.material_drawer_selected, hu.py82c7.homework.R.color.material_drawer_selected);
    }
    ...
    protected int getSelectedTextColor(Context ctx) {
        return ColorHolder.color(getSelectedTextColor(), ctx, hu.py82c7.homework.R.attr.material_drawer_selected_text, hu.py82c7.homework.R.color.material_drawer_selected_text);
    }
    ...
    public int getIconColor(Context ctx) {
        int iconColor;
        if (this.isEnabled()) {
            iconColor = ColorHolder.color(getIconColor(), ctx, hu.py82c7.homework.R.attr.material_drawer_primary_icon, hu.py82c7.homework.R.color.material_drawer_primary_icon);
        } else {
            iconColor = ColorHolder.color(getDisabledIconColor(), ctx, hu.py82c7.homework.R.attr.material_drawer_hint_icon, hu.py82c7.homework.R.color.material_drawer_hint_icon);
        }
        return iconColor;
    }
    ...
    protected int getSelectedIconColor(Context ctx) {
        return ColorHolder.color(getSelectedIconColor(), ctx, hu.py82c7.homework.R.attr.material_drawer_selected_text, hu.py82c7.homework.R.color.material_drawer_selected_text);
    }
