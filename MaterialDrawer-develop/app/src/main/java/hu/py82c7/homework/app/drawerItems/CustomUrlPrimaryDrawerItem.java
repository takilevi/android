...
import hu.py82c7.homework.model.interfaces.ColorfulBadgeable;
...
public class CustomUrlPrimaryDrawerItem extends CustomUrlBasePrimaryDrawerItem<CustomUrlPrimaryDrawerItem, CustomUrlPrimaryDrawerItem.ViewHolder> implements ColorfulBadgeable<CustomUrlPrimaryDrawerItem> {
    ...
    @Override
    public int getType() {
        return hu.py82c7.homework.app.R.id.material_drawer_item_custom_url_item;
    }

    @Override
    @LayoutRes
    public int getLayoutRes() {
        return hu.py82c7.homework.app.R.layout.material_drawer_item_primary;
    }
    ...
    public static class ViewHolder extends CustomBaseViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            this.badgeContainer = view.findViewById(hu.py82c7.homework.app.R.id.material_drawer_badge_container);
            this.badge = (TextView) view.findViewById(hu.py82c7.homework.app.R.id.material_drawer_badge);
        }
    }
}
