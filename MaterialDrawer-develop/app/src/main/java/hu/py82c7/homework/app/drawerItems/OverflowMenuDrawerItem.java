...
import hu.py82c7.homework.model.BaseDescribeableDrawerItem;
import hu.py82c7.homework.model.BaseViewHolder;
...
public class OverflowMenuDrawerItem extends BaseDescribeableDrawerItem<OverflowMenuDrawerItem, OverflowMenuDrawerItem.ViewHolder> {
    ...
    @Override
    public int getType() {
        return hu.py82c7.homework.app.R.id.material_drawer_item_overflow_menu;
    }

    @Override
    @LayoutRes
    public int getLayoutRes() {
        return hu.py82c7.homework.app.R.layout.material_drawer_item_overflow_menu_primary;
    }
    ...
    public static class ViewHolder extends BaseViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            this.menu = (ImageButton) view.findViewById(hu.py82c7.homework.app.R.id.material_drawer_menu_overflow);
        }
    }
}
